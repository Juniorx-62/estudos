...
!(function (t, e) {
    ...
    return (() => {
                ...
                _keyboard(t) {
                    ...
                    if (document.activeElement === o.wrapper) {
                        ...
                        if ("keydown" === n && (s || r || a || l)) {
                            let n = 0,
                                i = 0;
                            "v" === o ? (n = s || r ? 1 : -1) : "h" === o ? (n = s || r ? -1 : 1) : ((i = s ? -1 : a ? 1 : 0), (n = l ? -1 : r ? 1 : 0)), e.update(C(e.cache.x + 0.01 * n), C(e.cache.y + 0.01 * i)), t.preventDefault();
        ...
        const S = { variantFlipOrder: { start: "sme", middle: "mse", end: "ems" }, positionFlipOrder: { top: "tbrl", right: "rltb", bottom: "btrl", left: "lrbt" }, position: "bottom", margin: 8 },
            O = (t, e, o) => {
                const { container: n, margin: i, position: s, variantFlipOrder: r, positionFlipOrder: a } = { container: document.documentElement.getBoundingClientRect(), ...S, ...o },
        ...
        class L {
            constructor(t) {
                E(this, "_initializingActive", !0),
                    ...
                    E(this, "_eventListener", { init: [], save: [], hide: [], show: [], clear: [], change: [], changestop: [], cancel: [], swatchselect: [] }),
            ...
            _preBuild() {
                ...
                (this._root = ((t) => {
                    const { components.e, useAsButton: o, inline: n, appClass: i, theme: s, lockOpacity: r } = t.options,
                        ...
                        c = (e) => t._t(e),
                        p = a(
                            `\n      <div :ref="root" class="pickr">\n\n        ${o ? "" : '<button type="button" :ref="button" class="pcr-button"></button>'}\n\n        <div :ref="app" class="pcr-app ${i || ""}" data-theme="${s}" ${n ? 'style="position: unset"' : ""
        ...
        return (
            ...
            E(L, "I18N_DEFAULTS", {
                ...
                "btn:cancel": "Cancelar",
                "btn:clear": "Limpar",
                "aria:btn:save": "Salvar e fechar",
                "aria:btn:cancel": "Cancelar e fechar",
                "aria:btn:clear": "Limpar e fechar",
